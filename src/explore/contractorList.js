...
const ContractorList = () => {
  ...
  const MyMarker = (props) => (
    <div id={props.id} onClick={handleClick} className="circle">
  ...
  async function handleClick(e) {
    ...
    console.log("visible COntractor", visibleContractor)
    // setContractors((contractors)=>{
    //   contractors.map(contractor=>{
    //     if(contractor.id==clickedContractor){
    //       console.log("clocked", contractor)
       ...
       {visibleContractor.map((contractor) => {
        ...
        //  }
            ...
            >
              ...
              {contractors.map(contractor=>{
                return(
                  <MyMarker  id={contractor.id} lat={contractor.lat} lng={contractor.lng} />
                )
              })}
